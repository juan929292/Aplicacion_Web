...
INSERT INTO `directores` VALUES (1,'Quentin Tarantino','EEUU'),(2,'Eli Roth','EEUU'),(3,'Christopher Nolan','Inglaterra'),(4,'Steven Spielberg','EEUU'),(5,'Sylvester Stallone','EEUU'),(8,'Manolaso','Turquia');
...
CREATE TABLE `dirigida_por` (
  ...
  CONSTRAINT `dirigida_por_ibfk_2` FOREIGN KEY (`id_director`) REFERENCES `directores` (`id_director`)
...
INSERT INTO `dirigida_por` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(1,6),(2,4),(3,7),(3,8),(3,9),(4,10),(4,11),(4,12),(5,18);
...
CREATE TABLE `es` (
  ...
  CONSTRAINT `es_ibfk_2` FOREIGN KEY (`id_genero`) REFERENCES `generos` (`id_genero`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `generos` VALUES (0,'Accion'),(1,'Belico'),(2,'Thriller'),(3,'Aventura'),(4,'Comedia');
...
CREATE TABLE `posee` (
  ...
  CONSTRAINT `posee_ibfk_1` FOREIGN KEY (`id_pelicula`) REFERENCES `peliculas` (`id_pelicula`),
  CONSTRAINT `posee_ibfk_2` FOREIGN KEY (`id_valoracion`) REFERENCES `valoraciones` (`id_valoracion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tienen` (
  ...
  CONSTRAINT `tienen_ibfk_1` FOREIGN KEY (`id_pelicula`) REFERENCES `peliculas` (`id_pelicula`),
  CONSTRAINT `tienen_ibfk_2` FOREIGN KEY (`id_comentario`) REFERENCES `comentarios` (`id_comentario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
